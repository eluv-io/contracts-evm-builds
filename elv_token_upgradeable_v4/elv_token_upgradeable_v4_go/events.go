package elv_token_upgradeable_v4_go
...
import (
	...
	"github.com/eluv-io/contracts-evm-builds/elv_token_upgradeable_v4/elv_token_upgradeable_v4_go/events"
    "github.com/eluv-io/contracts-evm-builds/elv_token_upgradeable_v4/elv_token_upgradeable_v4_go/v0.0.0-dev"
)
...
var (
	...
	allEventInfos = []packageEvent{ 
		{ elv_token_upgradeable_v4_v0_0_0_dev.UniqueEvents, "v000_dev" },
	}
)
