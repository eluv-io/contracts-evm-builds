...
export type ElvTokenEvents =
  ...
  | 'Transfer'
  | 'Unpaused';
export interface ElvTokenEventsContext {
...
export type ElvTokenMethodNames =
  | 'new'
  | 'DEFAULT_ADMIN_ROLE'
  | 'allowance'
  | 'approve'
...
export interface ElvToken {
   ...
   * @param decimal Type: uint8, Indexed: false
