package elv_token_upgradeable_v2_go
...
import (
	...
	"github.com/eluv-io/contracts-evm-builds/elv_token_upgradeable_v2/elv_token_upgradeable_v2_go/events"
    "github.com/eluv-io/contracts-evm-builds/elv_token_upgradeable_v2/elv_token_upgradeable_v2_go/v0.0.0-dev"
)
...
var (
	...
	allEventInfos = []packageEvent{ 
		{ elv_token_upgradeable_v2_v0_0_0_dev.UniqueEvents, "v000_dev" },
	}
)
