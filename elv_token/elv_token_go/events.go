...
import (
	...
	"github.com/eluv-io/contracts-evm-builds/elv_token/elv_token_go/events"
    "github.com/eluv-io/contracts-evm-builds/elv_token/elv_token_go/v0.0.0-dev"
)
...
var (
	...
	allEventInfos = []packageEvent{ 
		{ elv_token_v0_0_0_dev.UniqueEvents, "v000_dev" },
	}
)
