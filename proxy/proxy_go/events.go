...
import (
	...
	"github.com/eluv-io/contracts-evm-builds/proxy/proxy_go/events"
    "github.com/eluv-io/contracts-evm-builds/proxy/proxy_go/v0.0.0-dev"
)
...
var (
	...
	allEventInfos = []packageEvent{ 
		{ proxy_v0_0_0_dev.UniqueEvents, "v000_dev" },
	}
)
